...
def get_additional_pool_data(pool_address, pool_abi):
    ...
    try:
        ...
        # Get historical data (observe function)
        # Note: You need to provide the secondsAgos array for the periods you want to observe
        secondsAgos = [60, 3600]  # Example values
        historical_data = pool_contract.functions.observe(secondsAgos).call()
...
for data in pool_data:
    ...
    print(f"Historical Data (Seconds Ago): {data[10]}")
